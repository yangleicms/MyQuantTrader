...
from Deribit_util.utils.printobject import PrintDate
from Deribit_util.utils.timeservice import get_current_timestamp
from Deribit_util.Deribit_Util import *

from Deribit_util.utils import *
from Deribit_util.utils.printobject import *
...
class WebsocketConnection:
    ...
    def __init__(self, uri, watch_dog, request):
        self.__thread = None
        self.url = uri
        ...
        self.logger = logging.getLogger("Deribit_Log")
